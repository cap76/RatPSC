function E60CornPlot(tvalue,sample,name,mycmapnew,CLimMin,CLimMax)
% function E60CornPlot(tvalue,sample,name,mycmapnew,CLimMin,CLimMax)
...
set(gca,'position',[0.1,0.6,0.13,0.13],'FontSize',8,'LineWidth',1); 
colorbar('FontSize',8);
