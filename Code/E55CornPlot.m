function E55CornPlot(tvalue,sample,name,mycmapnew,CLimMin,CLimMax)
% function E55CornPlot(tvalue,sample,name,mycmapnew,CLimMin,CLimMax)
...
%     sample: the name of all sample (cell array), the order much be consistent with the tvalue (eg. 1Epi, 2En1...)
...
set(gca,'position',[0.1,0.6,0.13,0.1],'FontSize',8,'LineWidth',1); 
colorbar('FontSize',8);
title(['\fontsize{8}' name],'position',[2.5,-1.1]);
