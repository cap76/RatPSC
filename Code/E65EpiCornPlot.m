function E65EpiCornPlot(tvalue,sample,genename,mycmapnew,CLimMin,CLimMax)
% function E65EpiCornPlot(tvalue,sample,name,mycmapnew,CLimMin,CLimMax)
...
weight=[0,0.23,0.37,0.42,0.47,0.48,0.49,0.5];
nodesize=90;
...
set(gca,'Ylim',[0,size(matrix1,1)+1],'YTick',1:size(matrix1,1),'FontSize',9,'LineWidth',1,'FontWeight','bold');
set(gcf,'Colormap',mycmapnew); 
colorbar('FontSize',6);
title(['\fontsize{9}' genename],'position',[1.5,-1.2]);
set(gca,'position',[0.1,0.5,0.12,0.3]);
